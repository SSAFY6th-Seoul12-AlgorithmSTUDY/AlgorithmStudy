...
public class Main_bj_10800_컬러볼 {
	...
	public static void main(String[] args) throws Exception{
        ...
        for (int i = 0; i < n; i++) {
            ...
            int c = Integer.parseInt(st.nextToken()); // i번째 공 색
            int s = Integer.parseInt(st.nextToken()); // i번째 공 크기
        ...
        //Collections.sort(balls, (Ball o1, Ball o2) -> o1.size - o2.size);
        
        
        int[] answer = new int[n]; // 각 공이 잡을 수 있는 공들의 사이즈 합 저장할 배열?
        ...
        for (int i = 0, j = 0; i < n; i++) {
            ...
            // 현재 공이 잡을 수 있는 공의 수 
            //(크기가 작은 전체 누적 공 크기 - 현재 공과 같은 색의 공 크기 합 -> ??)
...
//https://skygood95.tistory.com/85
//https://moonsbeen.tistory.com/376?category=1184369